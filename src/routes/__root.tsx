...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "AgentBazar.in" },
      { name: "description", content: "B2B Airfare Marketplace for Travel Agents" },
      { name: "author", content: "AgentBazar.in" },
      { property: "og:title", content: "AgentBazar.in" },
      { property: "og:description", content: "B2B Airfare Marketplace for Travel Agents" },
